...
if(isset($_POST['submit'])){
    ...
    $password=$_POST['reg_password'];
      ...
      if( $count> 0){
        ...
        $reg = new Database();
          $value = $reg->register_vendor($business_name,$service,$city,$email,$password);
          // echo $value;
          if($value=='true'){
            ...
            <form class="form" name="form_register" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="row" ng-class="((registerCtrl.errorFullName &amp;&amp; !form_account.full_name.$valid) ? 'form-error' : '')">
                    <label>
                        ...
                        <select name="reg_service" class="ng-pristine ng-valid">
                        <?php
                                  $data_service=array("");
                                  ...
                                  echo "<option value='0'>Select Service</option>";
                                    while ($key_service=$res_service->fetch()) {
                                      ?>
                                      <option value="<?php echo $key_service->id;?>"> <font style="font-style:italic;"><?php echo $key_service->service_name;?></font></option>
                                      <?php
                                    }
                        ?>
                        </select>
