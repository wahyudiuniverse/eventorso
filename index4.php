...
<div style="margin-right:16px;     width: 480px;" class="box-item">
  <div id="sticky-and-not-sticky">
    <div class="bg-white">
      <div class="pic">
        <a href=""><img title="Pic Avatar" src="dashboard/image_upload/default.png" style="height: 232px;"></a>
      </div>
      <div class="clear"></div>
    </div>
  </div>
...
<div style="margin-right:16px;" class="box-item">
  <div id="sticky-and-not-sticky">
    <div class="bg-white">
      <div class="pic">
        <a href=""><img title="Pic Avatar" src="dashboard/image_upload/default.png"></a>
      </div>
      <div class="clear"></div>
    </div>
  </div>
