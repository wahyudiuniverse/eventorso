...
<script type="text/javascript" >
 ...
 <script type="text/javascript">
        function OnClickButton () {
          $.post('saveprofile.php',{post_business_name:$('#pbusname').val(),
                                          post_fullname:$('#pfullname').val(),
                                          post_about:$('#pabout').val(),
                                          post_address:$('#paddress').val(),
                                          post_city:$('#pcity').val(),
                                          post_zip:$('#pzip').val(),
                                          post_mobile:$('#pmobile').val()
                        });
            ...
            <form id="imageform" name="form_picupload" class="form" method="post" enctype="multipart/form-data" action="ajaximage_profile.php">
                <div class="left w-150">
                        ...
                        <!-- <form name="businessDetail" class="ng-pristine ng-valid ng-valid-required"> -->
                            <div class="row mt-10">
                                <label>
                                    ...
                                    <input id="pbusname" value="<?php echo $key->business_name;?>" class="ng-pristine ng-valid ng-valid-required">
                                </label>
                            ...
                            <div class="row mt-10">
                                <label>
                                    ...
                                    <input id="pservice" value="<?php echo $key->service_name;?>" class="ng-pristine ng-valid ng-valid-required" disabled>
                                </label>
                            ...
                            <div class="row mt-10">
                                <label>
                                    ...
                                    <input id="pfullname" value="<?php echo $key->fullname;?>" class="ng-pristine ng-valid ng-valid-required">
                                </label>
                            ...
                            <div class="row">
                                <label>
                                    ...
                                    <textarea id="pabout" bs-maxlength="500" class="ng-pristine ng-valid" placeholder="Ceritakan tentang bisnis usaha anda"><?php echo $key->business_about;?></textarea>
                                </label>
                            ...
                            <div class="row">
                                <label>
                                    ...
                                    <textarea id="paddress" class="ng-pristine ng-valid" placeholder="Cantumkan alamat lengkap bisnis usaha anda"><?php echo $key->business_address;?></textarea>
                                </label>
                            </div>
                            <div class="row fixed">
                    ...
                    <div style="width: 100%;" class="box-select plain thicker georgia fixed-l">
                        <select id="pcity" class="ng-pristine ng-valid ng-valid-required">
                        <?php
                                  $data_city=array("");
                        ...
                        ?>
                            ...
                            <div class="row w-180">
                                <label class="block">
                                    ...
                                    <input id="pzip" value="<?php echo $key->area_code;?>" class="ng-pristine ng-valid">
                                </label>
                            </div>
                            ...
                            <div class="row w-180">
                                <label class="block">
                                    ...
                                    <input id="pmobile" value="<?php echo $key->mobile_phone;?>" class="ng-pristine ng-valid">
                                </label>
                            </div>

                            
  <div>
    <button onclick="OnClickButton()" class="btn with-border w-130">SIMPAN</button>
  </div>
